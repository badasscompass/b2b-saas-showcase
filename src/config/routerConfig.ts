...
export const routeConfig: RouteConfig[] = [
  {
    ...
    keywords: ['Iva Rumora', 'LMN3 Collective', 'product development', 'strategic advisory', 'product consultant', 'startup advisor', 'product manager', 'product management', 'product leadership'],
    preload: true
  },
  {
  ...
  },
  {
    ...
    keywords: ['Iva Rumora', 'LMN3 Collective', 'about', 'team', 'product consultant', 'strategic advisory', 'product manager', 'product management', 'senior product manager', 'product leadership']
  }
];
