    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold font-manrope text-gray-900 mb-6">
            Insights from Iva Rumora
          </h2>
          ...
          <Card className="border-2 border-[#EA3E3A]/20 bg-gradient-to-br from-[#EA3E3A]/5 to-[#F4A42C]/5 max-w-2xl mx-auto">
            <CardHeader className="p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  variant="outline"
                  className="border-[#EA3E3A] text-[#EA3E3A] hover:bg-[#EA3E3A] hover:text-white font-manrope"
                  asChild
                >
                  <a 
                    href="https://irumora.substack.com/subscribe" 
                    target="_blank" 
                    rel="noopener noreferrer"
                  >
                    Subscribe for Free
