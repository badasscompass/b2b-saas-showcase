...
export const HeroSection = () => {
  const benefits = ["Embedded teams", "Fractional leaders", "Ready in weeks, not months"];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="w-full max-w-[500px] mx-auto mb-8 transition-transform duration-300 hover:scale-105">
              <img src="/lovable-uploads/8dda91e1-93fc-4702-b5cf-9dc6dd55412b.png" alt="LMN3 Logo" className="w-full h-auto" />
            </div>
          </div>
...
fast-moving B2B teams</span>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
              <Button size="lg" className="bg-[#EA3E3A] text-white hover:bg-[#F4A42C] font-manrope text-lg px-8 py-4 transition-all hover:scale-105" asChild>
